...
style: |
  ...
  pre { background: #f1f4fa; border-left: 5px solid #f97583; padding: 10px 12px; border-radius: 6px; font-size: 0.66em; line-height: 1.22; overflow: auto; white-space: pre-wrap; word-break: break-word; }
  ...
  th { background: #e7edf8; color: #8f1f35; padding: 10px 14px; text-align: left; border: 1px solid #cfd6e3; }
