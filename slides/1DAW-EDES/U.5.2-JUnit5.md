...
style: |
  ...
  pre { background: #111827; border-left: 5px solid #79b8ff; padding: 14px 16px; border-radius: 6px; font-size: 0.74em; line-height: 1.35; overflow: auto; white-space: pre-wrap; word-break: break-word; }
