...
style: |
  ...
  pre { background: #f1f4fa; border-left: 5px solid #e2b96f; padding: 10px 12px; border-radius: 6px; font-size: 0.66em; line-height: 1.22; overflow: auto; white-space: pre-wrap; word-break: break-word; }
  ...
  .highlight { background: #eef2f9; border-left: 4px solid #e2b96f; padding: 14px 20px; border-radius: 0 6px 6px 0; margin: 16px 0; font-size: 0.9em; }
  ...
  th { background: #e7edf8; color: #7a5b1b; padding: 10px 14px; text-align: left; border: 1px solid #cfd6e3; }
