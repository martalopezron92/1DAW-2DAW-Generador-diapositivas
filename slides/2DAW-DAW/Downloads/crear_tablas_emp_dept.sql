...
-- Basado en el documento "Introducción a SQL sobre Oracle"
-- de Luis A. González Ares
-- ============================================================
...
-- --------------------------------------------------------------
SELECT 'Tabla DEPT' AS verificacion, COUNT(*) AS num_filas FROM dept
UNION ALL
SELECT 'Tabla EMP', COUNT(*) FROM emp;
